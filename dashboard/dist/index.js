    ...
    return h("div", {
      ...
      h(StepRow, { num: "1", done: !!(status.llmConnected || status.grokConnected), title: "Connect an AI model provider (powers your agent)" },
        h("div", { style: { color: MUTED, fontSize: 13 } },
          ...
          " and connect ANY provider you already use: sign in under OAuth Providers (Anthropic/Claude, OpenAI, xAI Grok, Nous, and more — the device-code flows work right in the browser), or paste a provider API key (e.g. ANTHROPIC_API_KEY, OPENAI_API_KEY, XAI_API_KEY). One provider is enough. Then pick your default model on the ",
          h("a", { href: "/models", style: { color: "var(--color-primary, #14b8a6)" } }, "Models page"),
          " if you don't want the preset (grok-4.5).")),
