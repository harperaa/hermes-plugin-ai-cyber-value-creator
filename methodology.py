...
def build_task_description(
    ...
    foundation_brief = [
        ...
        "a card. To ask:",
        "1. Post ONE kanban comment whose FIRST line is exactly `### ❓ QUESTION FOR",
        "   YOU`, followed by the question(s) in markdown — group every related",
        "   question into this single comment, with options/examples where helpful.",
        "2. THEN block the task with kind `needs_input` and reason 'Waiting for your",
        "   answer — see the question card.' Never put the question itself only in",
        "   the block reason, and never block without having posted the question",
        "   comment first.",
