...
def build_task_description(
    ...
    foundation_brief = [
        ...
        "   message MUST contain the complete question — options included as",
        "   bullet lines. This applies in every session type: the chat thread is",
        "   the only place the user can read and answer it, and a final message",
        "   that merely says a question was asked (or names its number) is a",
        "   protocol violation.",
